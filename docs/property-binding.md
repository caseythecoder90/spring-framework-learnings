...
```bash
grep -rn "class Binder" .spring-sources/
```
...
<!-- widget:path:property-binding -->

**You have understood this when you can say, without looking:** which class does relaxed matching,
and why it is the source rather than the Binder.
