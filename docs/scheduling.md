...
```bash
grep -rn "class SchedulingConfiguration" .spring-sources/
```
...
<!-- widget:path:scheduled-registration -->

**You have understood this when you can say, without looking:** why a `@Scheduled` method that
throws keeps its schedule.
