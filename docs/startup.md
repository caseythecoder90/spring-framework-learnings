...
```bash
grep -rn "class AbstractApplicationContext" .spring-sources/
```
...
**You have understood this when you can say, without looking:** what has already finished by the
time `ContextRefreshedEvent` fires.
