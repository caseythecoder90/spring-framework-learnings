...
```bash
grep -rn "class AbstractEnvironment" .spring-sources/
```
...
<!-- widget:path:property-lookup -->

**You have understood this when you can say, without looking:** why precedence is nothing more than
list order.
